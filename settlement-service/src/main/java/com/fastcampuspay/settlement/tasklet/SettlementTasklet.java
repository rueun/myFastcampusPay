...
public class SettlementTasklet implements  Tasklet {
    ...
    public RepeatStatus execute(StepContribution contribution, ChunkContext chunkContext){
        ...
        // 2. 각 결제 내역의 franchiseId 에 해당하는 멤버십 정보(membershipId)에 대한 뱅킹 정보(계좌번호) 를 가져온다.
        ...
        // 3. 각 franchiseId 별로, 정산 금액을 계산해주고(수수료를 제하지 않은 금액을 계산해준다.)
        for (Payment payment : normalStatusPaymentList) {

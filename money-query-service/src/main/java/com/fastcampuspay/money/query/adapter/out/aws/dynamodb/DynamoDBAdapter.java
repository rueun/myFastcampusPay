...
public class DynamoDBAdapter implements GetMoneySumByAddressPort, InsertMoneyIncreaseEventByAddress {
    ...
    public void insertMoneyIncreaseEventByAddress(String addressName, int moneyIncrease) {
        ...
        final String date = new SimpleDateFormat("yyMMdd").format(new Date());
        String pk = addressName + "#" + date;
    ...
    private void updateItem(String pk, String sk, int balance) {
        try {
            ...
            String balanceStr = String.valueOf(balance);
            HashMap<String, AttributeValueUpdate> attrUpdateMap = new HashMap<>();
            attrUpdateMap.put("balance", AttributeValueUpdate.builder()
                    .value(builder -> builder.n(balanceStr))
            ...
            UpdateItemRequest updateItemRequest = UpdateItemRequest.builder()
                    .tableName(TABLE_NAME)
                    .key(attrMap)
                    .attributeUpdates(attrUpdateMap)
                    .build();
